...
export default function DataTableFacetedFilter<TData, TValue>({
    ...
    const getFacetData = () => {
        ...
        if (isDataInArray && typeof facets !== "undefined") {
            const flattenedValues = Array.from(facets.keys()).flat();
            return flattenedValues.reduce((acc, value) => {
